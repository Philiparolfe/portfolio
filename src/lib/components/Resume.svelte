<section id="projects" class="flex my-7 lg:mx-32">
	<div class="p-4 card lg:p-10">
		<div class="flex flex-col gap-3 2xl:px-32">
			...
			<div class="flex lg:flex-row flex-col justify-around place-content-between">
				<div class="p-1">
				...
				<div class="p-1">
					...
					<p class="h4 text-secondary-300">
						Computer Systems Technology Program, George Brown College
					</p>
					<ul class=" list">
						<li>Developed and presented IT best practices.</li>
						<li>
							Explored key networking concepts and their applications within both a Windows Server
							environment and a Linux environment.
						</li>
						<li>Automated network and system configurations using Python.</li>
						<li>Monitored network and systems using Python.</li>
						<li>
							Developed and delivered an in-depth presentation on networking services available in
							Windows Server 2016.
						</li>
						<li>
							Configured and optimized various server environments ensuring efficient and secure
							performance.
						</li>
					</ul>
				</div>
			</div>
			<div class="flex lg:flex-row flex-col justify-around py-5">
				<div class="p-1">
			...
			<h3 class="text-secondary-300">
				Tini’s Treats | Farmers Market | Woodbridge & Milton | 2022-2023
			</h3>
			<ul class=" list ml-5">
				<li>
				...
				<li>Ensured a tidy and well-organized coffee stand.</li>
				<li>Assisted in packing and unpacking goods.</li>
				<li>
			...
			<ul class=" list ml-5">
				<li>Utilized RF scanners to locate and retrieve specific products from inventory.</li>
				...
				<li>Followed safety protocols and maintained a clean and organized work area.</li>
			</ul>
			<hr class="!border-dotted mt-2" />
			<h3 class="text-secondary-300">Machine Operator | AIB Co | Mississauga | 2019</h3>
			<ul class=" list ml-5">
				<li>Operated cutting and trimming machines.</li>
				<li>Ensured proper functioning and maintenance of equipment.</li>
				<li>Conducted regular inventory checks and maintained accurate records.</li>
				<li>ollowed safety protocols and maintained a clean work area.</li>
			</ul>
			<hr class="!border-dotted mt-2" />
		</div>
	</div>
