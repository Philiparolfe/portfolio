	...
	<div class="p-4 card flex justify-between">
		<div class="p-3 ">
			...
			<section class="">
				...
				<p>
					my website allows users to effortlessly transcribe spoken content directly from their
					microphone, providing a frictionless experience for capturing ideas, lectures, or any
					spoken information. This feature not only facilitates easy note-taking but also serves as
					a valuable tool for content creators, students, and professionals seeking a convenient way
					to capture and organize spoken information.
				</p>
				<br />
				<p>
					In addition to transcription, my website boasts robust translation capabilities, enabling
					users to seamlessly convert content from any language to english.
				</p>
			...
			<section class="">
                ...
                <div class="flex flex-col justify-center items-center">
                    <a
					href="https://youtube.com/shorts/KVRlYKLWhZY?si=qiTylGCtGurkLDsD"
					target="_blank"
					rel="noopener noreferrer"
					><h3 class="h3 text-center text-primary-400 hover:text-primary-300 my-4">
						Video Demo
					</h3></a
				>
			...
			<section class="">
				...
				<p>
					...
					conditions to create an optimal growth environment.
				</p>
				<hr class="!border-dotted my-5" />
			</section>
		</div>
